...
#ifndef LKL_ASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
#define LKL_ASIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
...
using boost::asio::detail::socket_holder;
