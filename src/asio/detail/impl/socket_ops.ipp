...
#ifndef LKL_ASIO_DETAIL_SOCKET_OPS_IPP
#define LKL_ASIO_DETAIL_SOCKET_OPS_IPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#include "src/asio/detail/socket_types.hpp"
...
#include "src/asio/detail/socket_ops.hpp"
#include "src/asio/detail/socket_types.hpp"
...
using lkl::asio::detail::invalid_socket;
using lkl::asio::detail::socket_error_retval;
using lkl::asio::detail::custom_socket_option_level;
    ...
    socket_type s, socket_addr_type* addr, std::size_t* addrlen)
{
  ...
  socket_type result = ::lkl_accept(s, addr, addrlen ? &tmp_addrlen : 0);
  if (addrlen)
    ...
    std::size_t* addrlen, boost::system::error_code& ec)
{
  ...
  int optval = 1;
  int result = error_wrapper(::lkl_setsockopt(new_s,
...
{
  return ::lkl_bind(s, addr, (SockLenType)addrlen);
}
    ...
    bool destruction, boost::system::error_code& ec)
{
  ...
  if (s != invalid_socket)
  {
    ...
    result = error_wrapper(::lkl_close(s), ec);
#endif // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
#else
  ioctl_arg_type arg = (value ? 1 : 0);
  int result = error_wrapper(::lkl_ioctl(s, FIONBIO, &arg), ec);
#endif
...
int shutdown(socket_type s, int what, boost::system::error_code& ec)
{
  ...
  clear_last_error();
  int result = error_wrapper(::lkl_shutdown(s, what), ec);
  if (result == 0)
    ec = boost::system::error_code();
  return result;
}
...
inline int call_connect(SockLenType msghdr::*,
    socket_type s, const socket_addr_type* addr, std::size_t addrlen)
{
  return ::lkl_connect(s, addr, (SockLenType)addrlen);
}
...
bool non_blocking_connect(socket_type s, boost::system::error_code& ec)
{
  ...
  int ready = ::lkl_select(s + 1, 0, &write_fds, &except_fds, &zero_timeout);
...
#else
  clear_last_error();
  int result = error_wrapper(::lkl_socketpair(af, type, protocol, sv), ec);
  if (result == 0)
    ec = boost::system::error_code();
  return result;
#endif
...
# else // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  int result = error_wrapper(::lkl_ioctl(s, SIOCATMARK, &value), ec);
# endif // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  if (result == 0)
    ec = boost::system::error_code();
# if defined(ENOTTY)
...
#else // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  int result = error_wrapper(::lkl_ioctl(s, FIONREAD, &value), ec);
#endif // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  if (result == 0)
    ec = boost::system::error_code();
#if defined(ENOTTY)
...
int listen(socket_type s, int backlog, boost::system::error_code& ec)
{
  ...
  clear_last_error();
  int result = error_wrapper(::lkl_listen(s, backlog), ec);
  if (result == 0)
    ec = boost::system::error_code();
  return result;
}
    ...
    int flags, boost::system::error_code& ec)
{
  ...
  signed_size_type result = error_wrapper(::lkl_recvmsg(s, &msg, flags), ec);
  if (result >= 0)
    ec = boost::system::error_code();
  return result;
#endif // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    ...
    int in_flags, int& out_flags, boost::system::error_code& ec)
{
  ...
  msg.msg_iov = bufs;
  msg.msg_iovlen = static_cast<int>(count);
  signed_size_type result = error_wrapper(::lkl_recvmsg(s, &msg, in_flags), ec);
  if (result >= 0)
  {
    ec = boost::system::error_code();
    ...
    int flags, boost::system::error_code& ec)
{
  ...
  flags |= MSG_NOSIGNAL;
#endif // defined(__linux__)
  signed_size_type result = error_wrapper(::lkl_sendmsg(s, &msg, flags), ec);
  if (result >= 0)
    ec = boost::system::error_code();
  return result;
#endif // defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    ...
    boost::system::error_code& ec)
{
  ...
  return s;
#else
  int s = error_wrapper(::lkl_socket(af, type, protocol), ec);
  if (s >= 0)
    ec = boost::system::error_code();
  return s;
#endif
...
{
  return ::lkl_setsockopt(s, level, optname,
    ...
    void* optval, std::size_t* optlen)
{
  ...
  int result = ::lkl_getsockopt(s, level, optname, (char*)optval, &tmp_optlen);
    ...
    socket_type s, socket_addr_type* addr, std::size_t* addrlen)
{
  ...
  int result = ::lkl_getpeername(s, addr, &tmp_addrlen);
  *addrlen = (std::size_t)tmp_addrlen;
  return result;
}
...
{
  SockLenType tmp_addrlen = (SockLenType)*addrlen;
  int result = ::lkl_getsockname(s, addr, &tmp_addrlen);
  *addrlen = (std::size_t)tmp_addrlen;
  return result;
}
...
#else
  int result = error_wrapper(::lkl_ioctl(s, cmd, arg), ec);
#endif
  if (result >= 0)
  {
    ec = boost::system::error_code();
...
#else
  int result = error_wrapper(::lkl_select(nfds, readfds,
...
int poll_read(socket_type s, state_type state, boost::system::error_code& ec)
{
  ...
  clear_last_error();
  int result = error_wrapper(::lkl_poll(&fds, 1, timeout), ec);
#endif // defined(BOOST_ASIO_WINDOWS)
       // || defined(__CYGWIN__)
       // || defined(__SYMBIAN32__)
  if (result == 0)
...
int poll_connect(socket_type s, boost::system::error_code& ec)
{
  ...
  fds.revents = 0;
  clear_last_error();
  int result = error_wrapper(::lkl_poll(&fds, 1, -1), ec);
  if (result >= 0)
    ec = boost::system::error_code();
  return result;
#endif // defined(BOOST_ASIO_WINDOWS)
