...
#ifndef LKL_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
#define LKL_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_BASE_HPP
...
using boost::asio::detail::socket_type;
using boost::asio::detail::socket_addr_type;
using boost::asio::socket_base;
using boost::asio::detail::reactor;
using boost::asio::detail::ioctl_arg_type;
using boost::asio::detail::buffer_sequence_adapter;
using boost::asio::null_buffers;
using boost::asio::detail::reactor_op;
using boost::asio::detail::reactive_socket_send_op;
using boost::asio::detail::reactive_socket_recv_op;
using boost::asio::detail::reactive_socket_recvfrom_op;
using boost::asio::detail::reactive_socket_recvmsg_op;
using boost::asio::detail::reactive_socket_sendto_op;
using boost::asio::detail::reactive_null_buffers_op;
...
# include "impl/reactive_socket_service_base.ipp"
