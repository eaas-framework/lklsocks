...
#ifndef LKL_ASIO_DETAIL_SOCKET_OPS_HPP
#define LKL_ASIO_DETAIL_SOCKET_OPS_HPP
...
using boost::asio::detail::shared_ptr;
using boost::asio::detail::weak_ptr;
...
void complete_iocp_connect(socket_type s,
...
boost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
