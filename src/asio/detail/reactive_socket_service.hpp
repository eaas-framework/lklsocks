...
#ifndef LKL_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
#define LKL_ASIO_DETAIL_REACTIVE_SOCKET_SERVICE_HPP
...
#include "src/asio/detail/reactive_socket_service_base.hpp"
...
using boost::asio::detail::reactive_socket_accept_op;
using boost::asio::detail::reactive_socket_connect_op;
